...
// Cat layout: side profile facing left
// - Pointy ears at cols 4, 8
// - Round head with one eye + highlight, pink nose
// - Tail rises from body rear (right side), curves up and back
// - White belly on the left
// - Two pairs of legs at bottom (walk frames offset)
const CAT_WALK1: SpriteFrame = [
  [_, _, _, _, cOL, _, _, _, cOL, _, _, _, _, _, _, _],
  [_, _, _, cOL, cEi, cOL, _, cOL, cEi, cOL, _, _, _, _, _, _],
  [_, _, cOL, cB, cB, cOL, cOL, cB, cB, cOL, _, _, _, _, cOL, _],
  [_, cOL, cB, cB, cB, cB, cB, cB, cB, cB, cOL, _, _, cOL, cB, cOL],
  [_, cOL, cB, cEw, cEy, cB, cB, cHi, cB, cB, cOL, _, cOL, cB, cOL, _],
  [_, cOL, cB, cB, cB, cNo, cB, cB, cB, cB, cOL, _, cOL, cB, cOL, _],
  [_, _, cOL, cB, cB, cB, cB, cB, cB, cOL, _, cOL, cB, cOL, _, _],
  [_, _, cOL, cB, cB, cB, cB, cB, cB, cB, cOL, cB, cOL, _, _, _],
  [_, cOL, cBe, cB, cB, cB, cB, cB, cB, cB, cB, cB, cOL, _, _, _],
  [_, cOL, cBe, cBe, cB, cB, cHi, cB, cB, cB, cB, cOL, _, _, _, _],
  [_, cOL, cBe, cBe, cB, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _],
  [_, cOL, cBe, cBe, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _, _],
  [_, _, cOL, cBe, cB, cOL, cOL, cOL, cB, cB, cOL, _, _, _, _, _],
  [_, _, cOL, cB, cB, cOL, _, _, cOL, cB, cOL, _, _, _, _, _],
  [_, _, cOL, cOL, _, _, _, _, _, cOL, cOL, _, _, _, _, _],
...
const CAT_WALK2: SpriteFrame = [
  ...
  [_, cOL, cBe, cBe, cB, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _],
  [_, cOL, cBe, cBe, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _, _],
  [_, _, _, cOL, cB, cB, cOL, cOL, cB, cB, cB, cOL, _, _, _, _],
  [_, _, cOL, cB, cB, cOL, _, _, cOL, cOL, _, _, _, _, _, _],
  [_, _, cOL, cOL, _, _, _, _, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const CAT_IDLE: SpriteFrame = [
  ...
  [_, cOL, cBe, cBe, cB, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _],
  [_, cOL, cBe, cBe, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _, _],
  [_, _, cOL, cBe, cB, cB, cB, cB, cB, cB, cOL, _, _, _, _, _],
  [_, _, cOL, cB, cB, cOL, cOL, cOL, cOL, cB, cOL, _, _, _, _, _],
  [_, _, cOL, cOL, _, _, _, _, _, cOL, cOL, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const DOG_WALK1: SpriteFrame = [
  ...
  [_, _, dOL, dOL, dB, dB, dHi, dB, dB, dOL, dOL, _, _, _, _, _],
  [_, dOL, dSh, dOL, dEw, dEy, dB, dB, dB, dOL, dSh, dOL, _, _, _, _],
  [_, dOL, dSh, dOL, dB, dB, dWh, dWh, dB, dOL, dSh, dOL, _, _, _, _],
...
const DOG_IDLE: SpriteFrame = [
  ...
  [_, _, _, dOL, dB, dB, dB, dB, dOL, _, _, _, _, _, _, _],
  [_, _, dOL, dOL, dB, dB, dHi, dB, dB, dOL, dOL, _, _, _, _, _],
  [_, dOL, dSh, dOL, dEy, dEy, dB, dB, dB, dOL, dSh, dOL, _, _, _, _],
  [_, dOL, dSh, dOL, dB, dB, dWh, dWh, dB, dOL, dSh, dOL, _, _, _, _],
  [_, _, dOL, dOL, dWh, dNo, dWh, dB, dB, dB, dOL, _, _, _, _, _],
  [_, _, _, dOL, dWh, dWh, dB, dB, dB, dB, dB, dOL, _, _, _, _],
  [_, _, _, _, dOL, dCo, dCo, dCo, dB, dB, dB, dB, dOL, _, _, _],
...
// Hamster layout:
// - Round ears visible at cols 3-4 and 8-9 (2x2 each)
// - Large cheek pouch on left side (facing left)
// - Eye with white highlight + pink nose
// - Rounded body with belly
// - Two feet at bottom (walk frames alternate)
const HAMSTER_WALK1: SpriteFrame = [
  [_, _, _, hOL, hOL, _, _, _, hOL, hOL, _, _, _, _, _, _],
  [_, _, hOL, hEa, hEa, hOL, _, hOL, hEa, hEa, hOL, _, _, _, _, _],
  [_, _, hOL, hEa, hEa, hOL, hOL, hOL, hEa, hEa, hOL, _, _, _, _, _],
  [_, hOL, hB, hB, hB, hHi, hHi, hB, hB, hB, hB, hOL, _, _, _, _],
  [_, hOL, hB, hEw, hEy, hB, hB, hB, hB, hB, hB, hOL, _, _, _, _],
  [hOL, hB, hBe, hB, hB, hNo, hB, hB, hB, hHi, hB, hB, hOL, _, _, _],
  [hOL, hB, hBe, hBe, hB, hB, hB, hB, hB, hB, hB, hB, hOL, _, _, _],
  [hOL, hBe, hBe, hBe, hB, hB, hB, hB, hB, hB, hB, hB, hOL, _, _, _],
  [hOL, hBe, hBe, hBe, hB, hB, hB, hB, hB, hB, hB, hSh, hOL, _, _, _],
  [_, hOL, hBe, hB, hB, hB, hB, hB, hB, hB, hSh, hOL, _, _, _, _],
  [_, hOL, hB, hB, hB, hB, hB, hB, hB, hB, hSh, hOL, _, _, _, _],
  [_, _, hOL, hB, hB, hB, hB, hB, hB, hB, hOL, _, _, _, _, _],
  [_, _, _, hOL, hOL, hOL, _, _, hOL, hOL, _, _, _, _, _, _],
  [_, _, _, hOL, hSh, hOL, _, _, hSh, hOL, _, _, _, _, _, _],
  [_, _, _, hOL, hOL, _, _, _, hOL, hOL, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const HAMSTER_WALK2: SpriteFrame = [
  ...
  [_, hOL, hB, hB, hB, hB, hB, hB, hB, hB, hSh, hOL, _, _, _, _],
  [_, _, hOL, hB, hB, hB, hB, hB, hB, hB, hOL, _, _, _, _, _],
  [_, _, _, hOL, hOL, _, _, hOL, hOL, hOL, _, _, _, _, _, _],
  [_, _, _, hOL, hSh, _, _, hOL, hSh, hOL, _, _, _, _, _, _],
  [_, _, _, hOL, hOL, _, _, _, hOL, hOL, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const HAMSTER_IDLE: SpriteFrame = [
  ...
  [_, hOL, hB, hB, hB, hB, hB, hB, hB, hB, hSh, hOL, _, _, _, _],
  [_, _, hOL, hB, hB, hB, hB, hB, hB, hB, hOL, _, _, _, _, _],
  [_, _, _, hOL, hOL, hOL, _, _, hOL, hOL, hOL, _, _, _, _, _],
  [_, _, _, hOL, hSh, hOL, _, _, hOL, hSh, hOL, _, _, _, _, _],
  [_, _, _, hOL, hOL, _, _, _, _, hOL, hOL, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
// Frog layout: symmetrical (front view), squat pose
// - Two prominent eye bulges on top with pupils + white highlights
// - Wide body with lighter belly
// - Front legs at the sides, back legs splayed at bottom
const FROG_WALK1: SpriteFrame = [
  [_, _, _, gOL, gOL, _, _, _, _, gOL, gOL, _, _, _, _, _],
  [_, _, gOL, gEb, gEp, gOL, _, gOL, gEp, gEb, gOL, _, _, _, _, _],
  [_, _, gOL, gOL, gOL, gOL, gOL, gOL, gOL, gOL, gOL, _, _, _, _, _],
  [_, gOL, gB, gB, gHi, gB, gB, gB, gB, gHi, gB, gOL, _, _, _, _],
  [_, gOL, gB, gB, gB, gB, gB, gB, gB, gB, gB, gOL, _, _, _, _],
  [gOL, gB, gB, gB, gSh, gB, gB, gSh, gB, gB, gB, gB, gOL, _, _, _],
  [gOL, gB, gBe, gBe, gBe, gBe, gBe, gBe, gBe, gBe, gB, gB, gOL, _, _, _],
  [gOL, gB, gBe, gBe, gBe, gBe, gBe, gBe, gBe, gBe, gBe, gB, gOL, _, _, _],
  [gOL, gSh, gB, gBe, gBe, gBe, gBe, gBe, gBe, gBe, gB, gSh, gOL, _, _, _],
  [_, gOL, gSh, gB, gBe, gBe, gBe, gBe, gBe, gB, gB, gOL, _, _, _, _],
  [_, _, gOL, gSh, gB, gB, gB, gB, gB, gB, gOL, _, _, _, _, _],
  [_, gOL, gOL, gB, gB, gOL, gOL, gOL, gOL, gB, gB, gOL, gOL, _, _, _],
  [gOL, gB, gB, gB, gOL, _, _, _, _, gOL, gB, gB, gB, gOL, _, _],
  [gOL, gB, gOL, gB, _, _, _, _, _, _, gB, gOL, gB, gOL, _, _],
  [gOL, gOL, _, gOL, _, _, _, _, _, _, gOL, _, gOL, gOL, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const FROG_WALK2: SpriteFrame = [
  ...
  [_, _, gOL, gSh, gB, gB, gB, gB, gB, gB, gOL, _, _, _, _, _],
  [_, gOL, gOL, gB, gB, gOL, gOL, gOL, gOL, gB, gB, gOL, gOL, _, _, _],
  [gOL, gB, gB, gOL, _, _, _, _, _, _, gOL, gB, gB, gOL, _, _],
  [gOL, gB, gOL, _, _, _, _, _, _, _, _, gOL, gB, gOL, _, _],
  [gOL, gOL, _, _, _, _, _, _, _, _, _, _, gOL, gOL, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
